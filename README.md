...
An enhanced Raycast extension for [Obsidian](https://obsidian.md/) with comprehensive multi-vault support. Manage multiple Obsidian vaults with favorites, custom display names, vault switching, cross-vault search, and hotkey support.

## Contributors

**Josh Stephens** ([@joshstephens](https://github.com/joshstephens)) - Windows support, lazy loading, image rendering, Excalidraw handling, performance optimizations

**Claude (Opus 4.5)** - AI pair programmer by [Anthropic](https://anthropic.com) - Code analysis, debugging, implementation, and documentation

### Previous Developers

- **[Marc Julian Schwarz](https://marc-julian.de/)** - Original extension creator
...
- Fixed Raycast Windows beta compatibility (`raycast-x` config path)
...
For the full development story, see [DEVELOPMENT_STORY.md](./DEVELOPMENT_STORY.md).

---

## What's New in Multi-Vault Edition

This fork adds powerful multi-vault features while maintaining full compatibility with the original extension:
...
1. **Manage Vaults** - Configure vault settings, favorites, and display customization
2. **Switch Active Vault** - Quick switcher for changing the active vault
3. **Recent Notes** - Browse recently modified notes across all vaults with time filters (24h/7d/30d)
